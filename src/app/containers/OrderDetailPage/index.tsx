...
const OrderDetail = () => {
  ...
  const subTotal = orderDetails.reduce(
    (acc, detail) => acc + detail.actualPrice,
    0
  );
      ...
      <OrderDetailContainer>
        <div className="py-10 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
          <div className="flex justify-start item-start space-y-2 flex-col">
                ...
                <div className="block p-3 border border-primary text-gray-600 w-full text-sm ">
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-start p-2 text-md bg-gray-300">
                      <WarningAmberIcon /> Sau khi hoàn tất chuyển khoản, thư
                      xác nhận thanh toán sẽ được gửi vào hòm thư của email đặt
                      hàng. Trong trường hợp quá 3 tiếng mà chưa nhận được thư
                      xác nhận, bạn vui lòng kiểm tra mục spam hoặc nhắn tin qua
                      fanpage VietaFood tại{" "}
                      <a
                        className="underline"
                        href="https://www.facebook.com/VietaFood"
                      >
            ...
            {status === "Unpaid" ? (
              <h1 className="text-lg lg:text-2xl font-medium leading-7 lg:leading-9 text-red-500">
                Trạng thái: {translateStatus(status)}
              </h1>
            ) : (
              <h1 className="text-lg lg:text-2xl font-medium leading-7 lg:leading-9 text-green-500">
                Trạng thái: {translateStatus(status)}
              </h1>
            )}
            <p className="text-base font-medium leading-6 text-gray-600">
              Ngày đặt hàng: {new Date(createdAt).toLocaleString()}
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                      ...
                      <div className="flex justify-between space-x-8 items-start w-full">
                        ...
                        <p className="text-basexl:text-lg leading-6 text-gray-800">
                          x {detail.quantity}
                        </p>
                ...
                <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                  ...
                  <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                    ...
                    <div className="flex justify-between items-center w-full">
                      ...
                      <p className="text-base leading-4 text-gray-600">
                        (phí ship tính theo app giao hàng)
                      </p>
                    </div>
                  </div>
                  <div className="flex justify-between items-center w-full">
